...
const Dashboard = ({ user }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-12 animate-in fade-in duration-700">
      {/* Welcome Hero */}
      <section className="relative overflow-hidden rounded-3xl bg-[#1e3a8a] p-8 md:p-12 text-white shadow-2xl shadow-blue-900/20">
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4">
            <Link to="/menu" className="bg-white text-[#1e3a8a] px-8 py-3 rounded-xl font-bold hover:bg-blue-50 transition-all flex items-center group">
              View Today's Menu
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <h2 className="text-2xl font-bold text-slate-900 flex items-center">
            <span className="w-8 h-8 bg-blue-50 text-[#1e3a8a] rounded-lg flex items-center justify-center mr-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link to="/suggestions" className="group bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">New Suggestion</h3>
              <p className="text-slate-500 text-sm leading-relaxed mb-6">Have a specific dish in mind? Propose it to our chefs and see it on the menu.</p>
              <span className="text-[#1e3a8a] text-xs font-black uppercase tracking-widest flex items-center group-hover:translate-x-2 transition-transform">
                Propose a dish <ArrowRight className="ml-2 w-3 h-3" />
              </span>
            </Link>

            <Link to="/feedback" className="group bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Rate Your Meal</h3>
              <p className="text-slate-500 text-sm leading-relaxed mb-6">Help us maintain high quality standards by rating your recent dining experience.</p>
              <span className="text-[#1e3a8a] text-xs font-black uppercase tracking-widest flex items-center group-hover:translate-x-2 transition-transform">
          ...
          {/* Featured Meal Card */}
          {!loading && lunchItem && (
            <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col md:flex-row group hover:border-blue-100 transition-all">
              ...
              <div className="md:w-3/5 p-8 flex flex-col justify-center">
                ...
                <h3 className="text-2xl font-black text-slate-900 mb-3">{lunchItem.name}</h3>
                <p className="text-slate-500 leading-relaxed mb-6 italic">"{lunchItem.description}"</p>
                <Link to="/menu" className="text-[#1e3a8a] text-sm font-bold flex items-center hover:underline">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-3xl p-8">
            <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center mb-6 shadow-sm">
              <Info className="text-[#1e3a8a] w-5 h-5" />
            </div>
            <h3 className="text-[#1e3a8a] font-bold text-lg mb-2">Sustainable Campus</h3>
